...
export const DUMMY_ALERTS: Alert[] = [
  {
    ...
    location: 'Border Sector West',
    coordinates: { lat: 24.8, lng: 69.6 },
    threatSource: 'pak_west',
  ...
  },
  {
    ...
    location: 'Eastern Border Checkpoint',
    coordinates: { lat: 24.1, lng: 91.6 },
    threatSource: 'bangladesh',
  ...
  },
  {
    ...
    location: 'Northern Patrol',
    coordinates: { lat: 33.5, lng: 78.0 },
    threatSource: 'china_north',
  ...
  },
  {
    ...
    coordinates: { lat: 7.9, lng: 81.0 },
    threatSource: 'sri_lanka',
    status: AlertStatus.RESOLVED,
    dispatchLog: [],
    evidence: [],
  },
